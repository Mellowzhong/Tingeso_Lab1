...
function ComercialPropertyForm({ creditId }) {
    ...
    const [businessFinanceState, setBusinessFinanceState] = useState(false);
        ...
        <div className="w-full max-w-md bg-white shadow-md rounded-lg p-6 mt-8">
            ...
            <form className="grid gap-4">
                <DocumentForm
                    ...
                    isFileLoadedFunction={setBusinessFinanceStateFileLoaded}
                    creditId={creditId}
                />
                {
                    businessFinanceStateFileLoaded && (
                        <span id='businessFinanceStateFileLoaded' className="text-green-600 text-sm mt-1 mx-auto">
                ...
                <DocumentForm
                    ...
                    isFileLoadedFunction={setBusinessPlanFileLoaded}
                    creditId={creditId}
                />
                {
                    businessPlanFileLoaded && (
                        <span id='businessPlanFileLoaded' className="text-green-600 text-sm mt-1 mx-auto">
                            Archivo cargado correctamente
                        </span>
                    )
